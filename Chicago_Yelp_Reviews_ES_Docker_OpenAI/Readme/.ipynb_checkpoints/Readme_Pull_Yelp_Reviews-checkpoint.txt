HOW TO PULL ELASTICSEARCH Vector DB DOCKER IMAGE*********************************************

Requirements -> elasticsearch 8.12.0 and openAI 1.7.2 
	...
	Step_2.1: Open docker-compose.yml and update the docker image name with YOUR-DOCKERHUB-USERNAME/[REPOSITORY[:TAG]] (This will be the image that you pushed to docker hub).
		  For ex -> prakharnag98/elasticsearch_vector:multi
...
If you are face any issues in Step 2, alternatively, you can also do :Alternatively, you can also do :1.  docker pull YOUR-DOCKERHUB-USERNAME/[REPOSITORY[:TAG]]
    ...
    docker pull prakharnag98/elasticsearch_vector:multi
2. docker-compose up (you need to be in your project directory)3. Verify that elasticsearch is running and the data can be fetched
